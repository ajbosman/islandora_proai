 ...
 *    1. removes all itemID relations of objects that do not have a PROAI actived content model or are not in a PROAI activated collection
 *    2. adds itemID relations to the RELS-EXT datastream of objects with a PROAI actived content model
 *       in the PROAI activated collections, if not present
 *
 * Use this script when content models are activated of deactivated, and
 * when collections are are activated of deactivated.
 *
 */
